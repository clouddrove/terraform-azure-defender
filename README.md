...
<a href='https://www.linkedin.com/shareArticle?mini=true&title=Terraform+AZURE+DEFENDER&url=https://github.com/clouddrove/terraform-azure-log-analytics'>
  <img title="Share on LinkedIn" src="https://user-images.githubusercontent.com/50652676/62817742-4e339e80-bb59-11e9-87b9-a1f68cae1049.png" />
</a>
<a href='https://twitter.com/intent/tweet/?text=Terraform+AZURE+DEFENDER&url=https://github.com/clouddrove/terraform-azure-log-analytics'>
...
```hcl
module "defender" {
 source                           = "clouddrove/defender/azure"
 enabled                          = true
 resource_id                      = ""
 }
  ```
...
| resource\_id | Resource Id for which defender has to be enabled} | `string` | `""` | no |

## Outputs

| Name | Description |
|------|-------------|
| defender\_id | The ID of the Advanced Threat Protection resource. |
